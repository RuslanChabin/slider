...
container.style.padding = "10px"; //set slider list

var sliderList = document.createElement("ul");
sliderList.style.listStyle = "none";
container.insertBefore(sliderList, sliderButtonAdd); //set button
...
container.appendChild(sliderButtonAdd); //set slider
